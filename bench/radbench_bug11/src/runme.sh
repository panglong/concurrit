...
RUN_DIR=/home/elmas/radbench/Benchmarks/bug11
...
function setup {
	...
	DYLD_LIBRARY_PATH="$BENCHDIR/lib:$DYLD_LIBRARY_PATH" \
    	MALLOC_CHECK_=3 /home/elmas/radbench/Benchmarks/bug11/bin/install/bin/httpd -X -DNO_DETACH -DFOREGROUND &
    #eval $TEST_CALL
