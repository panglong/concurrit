...
alias instrument_demo2='cp -f $CONCURRIT_HOME/bench/demo/src/boundedBuffer_Instrumented2.c $CONCURRIT_HOME/bench/demo/src/boundedBuffer.c && compile_demo'
...
alias copy_finfile3='cp -f $CONCURRIT_HOME/bench/demo/finfile3.txt $CONCURRIT_HOME/bench/demo/finfile.txt'
...
alias BuggySchedule='instrument_demo2 && copy_finfile3 && export TEST="BuggySchedule" && copy_testfile && run_test'
