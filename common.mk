...
CONCURRIT_INC_FLAGS=$(CONCURRIT_DEBUG_FLAGS) -I$(CONCURRIT_INCDIR) -I$(CONCURRIT_SRCDIR) -I$(CONCURRIT_TPDIR)/glog/include -I$(BOOST_ROOT) -I$(CONCURRIT_TPDIR)/Mersenne-1.1
CONCURRIT_LIB_FLAGS=-L$(CONCURRIT_LIBDIR) -L$(CONCURRIT_TPDIR)/glog/lib -lpthread -lglog -ldl
