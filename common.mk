...
CONCURRIT_PINTOOL_INC_FLAGS=-I$(CONCURRIT_INCDIR) -I$(CONCURRIT_HOME)/tbb/include -fomit-frame-pointer
CONCURRIT_PINTOOL_LIB_FLAGS=-L$(CONCURRIT_LIBDIR) $(CONCURRIT_LIB_FLAG) -L$(CONCURRIT_HOME)/tbb/lib/ia32/cc4.1.0_libc2.4_kernel2.6.16.21 -ltbb 
