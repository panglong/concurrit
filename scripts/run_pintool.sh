...
PINTOOL_ARGS="-skip_int3 -finfile $CONCURRIT_HOME/work/finfile.txt -log_file $CONCURRIT_HOME/work/pinlogfile.txt -filtered_images_file $CONCURRIT_HOME/work/filtered_images.txt"
PROGRAM_ARGS="$@"
